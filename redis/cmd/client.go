...
type ApertureClient struct {
	server	*ApertureSvr
	db		*aperture_redis.RedisDS
}

type cmdHandler func(cli *ApertureClient, args [][]byte) (interface{}, error)
...
func execClientCommand(conn redcon.Conn, cmd redcon.Command) {
	...
	client, _ := conn.Context().(*ApertureClient)
	switch command {
	case "quit":
		_ = conn.Close()
	case "ping":
...
func set(cli *ApertureClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
...
func get(cli *ApertureClient, args [][]byte) (interface{}, error) {
	if len(args) != 1 {
...
func hset(cli *ApertureClient, args [][]byte) (interface{}, error) {
	if len(args) != 3 {
...
func sadd(cli *ApertureClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
...
func lpush(cli *ApertureClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
...
func zadd(cli *ApertureClient, args [][]byte) (interface{}, error) {
	if len(args) != 3 {
